...
sqldf(query)
```
Lastly, let's do a tougher example. We want to find instances where the PHillies in the 1970's hit more than 30 home runs. The tricky part is figuring out how to display data between 1970 and 1979. This is how I wrote the query:
```{r}
