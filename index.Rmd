...
This section is about grouping. Our first example asks us to find all of Babe Ruth's home runs. If we write the query like this:
```{r}
...
Next question. Find the career home run totals for all players but limit the output to total 600 or more. Order by career total. When you group before you filter you use "having" instead of "where."
